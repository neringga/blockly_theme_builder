...
Blockly.PHP['front_page'] = function(block) {
  var value_margin = Blockly.PHP.valueToCode(block, 'margin', Blockly.PHP.ORDER_ATOMIC);
...
Blockly.PHP['image'] = function(block) {
  var value_image_url = Blockly.PHP.valueToCode(block, 'image_url', Blockly.PHP.ORDER_ATOMIC);
  var number_image_opacity = block.getFieldValue('image_opacity');
  var value_width = Blockly.PHP.valueToCode(block, 'width', Blockly.PHP.ORDER_ATOMIC);
  var value_height = Blockly.PHP.valueToCode(block, 'height', Blockly.PHP.ORDER_ATOMIC);
...
Blockly.PHP['archive'] = function(block) {
  ...
  var value_margin = Blockly.PHP.valueToCode(block, 'margin', Blockly.PHP.ORDER_NONE);
  // TODO: Assemble PHP into code variable.
  var code = `<?php /* Template Name: Archive */ ?>`;
  return code;
};
...
Blockly.PHP['posts'] = function(block) {
  ...
  var checkbox_show_part_of_the_content = block.getFieldValue('show_part_of_the_content') == 'TRUE';
  ...
  var thumbnail_code = checkbox_show_thumbnail ? `<?php if(has_post_thumbnail()):?>            
                                                  ...
                                                  <?php endif;?>` : "";
  var content = checkbox_show_part_of_the_content ? "the_excerpt()" : "the_content()";
  ...
  var code = `<?php
              ...
              <?php if($_posts->have_posts()):?>
                ...
                <?php while($_posts->have_posts()): $_posts->the_post();?>
                  ...
                  <a href="<?php the_permalink();?>">
                  <p ${value_post_title_style}><?php the_title();?></p>
                  </a>
                  <?php ${content};?>
...
Blockly.PHP['content_margin'] = function(block) {
  ...
  var code = ` style="margin-right:${value_right_margin};
